...
namespace SHMS.Backend.Migrations
{
    public partial class AddAuditLogs : Migration
    {
        ...
        {
            // Only the AuditLogs table is new — all other tables already exist in the DB.
        ...
        private void UNUSED_Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AspNetRoles",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RosterSchedule = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NurseNotes = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CareInstructions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CareInstructions_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CareInstructions_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CareInstructions_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CareInstructions_DoctorId",
                table: "CareInstructions",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_CareInstructions_NurseId",
                table: "CareInstructions",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_CareInstructions_PatientId",
                table: "CareInstructions",
                column: "PatientId");
